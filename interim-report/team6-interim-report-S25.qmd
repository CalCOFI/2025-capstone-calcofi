...
[^3]: Wolfe Paper: <https://www.nature.com/articles/s43247-023-01065-0>
...
## Oceanographic and Carbonate Chemistry Data[^5]

[^5]: Bottle Database: <https://calcofi.org/data/oceanographic-data/bottle-database/>
...
### CalCOFI NOAA Zooplankton Volume[^6]:

[^6]: CalCOFI Zooplankton Volume Database: <https://oceanview.pfeg.noaa.gov/erddap/tabledap/erdCalCOFIzoovol.html>
...
### BTEDB (Krill) Abundances[^7]:

[^7]: BTEDB (Krill Volume) Data: <https://portal.edirepository.org/nis/mapbrowse?packageid=knb-lter-cce.313.1>
...
### PRPOOS (Calcifiers/Non-Calcifiers)[^8]:

[^8]: PRPOOS (Zooplankton Calcifiers/Non-Calcifiers Volume) Zooscan Database: <https://oceaninformatics.ucsd.edu/zooscandb/>
...
![Figure 1: ESPER NN predictions plotted against observed values of TA and DIC. Perfect predictions are represented by the solid diagonal line in black (the further a point is from this line, the less accurate the prediction).](~/capstone-calcofi-seagrant/interim-report/img/team6-figure1.png){width="70%"}
