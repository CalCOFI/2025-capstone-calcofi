...
![Figure 11: PCA biplot overlaid with K-means clustering results (k = 3).](~/capstone-calcofi-seagrant/interim-report/img/team6-figure11.png){width=40%}
...
When modeling the difference between calcifiers and non-calcifers, we explored LASSO regression and spatial GAMS. The performance of the LASSO regression was not optimal (see Tables 5-6 in Appendix).
