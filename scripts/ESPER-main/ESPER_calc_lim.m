...
writetable(EST_LIR_TAB,"../../data/ESPER_output/ESPER_LIR_est_lim.csv")
writetable(UNC_LIR_TAB,"../../data/ESPER_output/ESPER_LIR_unc_lim.csv")
writetable(EST_NN_TAB,"../../data/ESPER_output/ESPER_NN_est_lim.csv")
writetable(UNC_NN_TAB,"../../data/ESPER_output/ESPER_NN_unc_lim.csv")
writetable(EST_MIXED_TAB,"../../data/ESPER_output/ESPER_Mixed_est_lim.csv")
writetable(UNC_MIXED_TAB,"../../data/ESPER_output/ESPER_Mixed_unc_lim.csv")