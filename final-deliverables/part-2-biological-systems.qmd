...
Calculate the calcifying_ratio as the ratio of calcifying to non-calcifying species.
Classify observations as High or Low based on the median calcifying_ratio.
Build a logistic regression model to assess the impact of pH_mean, OmegaAR_mean, and CO3_mean.
```{r}
