...
writetable(EstimateTable,"data/ESPER_output/ESPER_estimates_anom_fix_all.csv")
writetable(UncertaintyTable,"data/ESPER_output/ESPER_uncertainties_anom_fix_all.csv")